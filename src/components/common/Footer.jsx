  ...
  return (
    <>
      <footer className="footer" >
          ...
          <div className="row">
            ...
            <div className="footer-col">
              ...
              <div className="social-links">
                <a
                  href="https://www.linkedin.com/in/anand-raj-6880271b9/"
                  target="blank"
                >
                  <FaLinkedin className=" mx-auto mt-3 scale-125" />
                </a>
                <a href="https://twitter.com/ARaj61" target="blank">
                  <FaTwitter className=" mx-auto mt-3 scale-125" />
                </a>

                <a href="https://www.instagram.com/arajshow/" target="blank">
        ...
        <p className="text-white text-2xl my-2  ">© Araj</p>
        <div className=" ">
